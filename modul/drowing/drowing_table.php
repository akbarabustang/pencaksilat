...
<div class="container">
    ...
    <div class="row row-centered">
        ...
        <a href="./modul/drowing/drowing_laporan1.php?id_drowing=<?php echo $id_drowing_get;?>&pool=<?php echo $pool;?>" class="btn btn-primary"><span class="glyphicon glyphicon-print"></span>  Print Jadwal Pertandingan : Pool <?php echo $pool; ?> </a> <br><br>
